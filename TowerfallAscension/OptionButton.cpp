...
OptionButton::OptionButton(const Point2f& location, const Point2f& startLocation, const ResourceManager* resources, float scale)
	:Button(resources->GetTextureManager()->GetTexture(TextureManager::TextureSheet::BUTTON_OPTIONS),
		location, startLocation, "Options", Text::Size::MEDIUM, Screen::ScreenType::OPTIONS, resources, Vector2f{ 0.f, -100.f }, scale)
	,m_RotSpeed{720.f}
{
}

void OptionButton::Update(float elapsedSec)
{
